...
function playgame(game) {
        ...
        if (game == 9) contanidor = '<div class = "col-md-2"></div><div class = "col-md-8"><div id="game">'+butons+'<iframe id="capt" src="https://gilbertvs.github.io/obstacle/" width=100% height="820" frameborder="0" style="border:0" allowfullscreen> </iframe></div></div>';
        ...
        if (game == 12) contanidor = '<div class = "col-md-1"></div><div class = "col-md-10"><div id="game">'+butons+'<iframe id="capt" src="https://gilbertvs.github.io/Shooter/" width=100% height="690" frameborder="0" style="border:0" allowfullscreen> </iframe></div></div>';


        if (game == 13) contanidor = window1 + butons + window2 + 'https://gilbertvs.github.io/Million/' + window3;

        if (game == 14) contanidor = window1 + butons + window2 + 'https://gilbertvs.github.io/City/' + window3;
