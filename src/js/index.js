...
function playgame(game) {
        ...
        if (game == 8) contanidor = window1 + butons + window2 + 'https://gilbertvs.github.io/Labyrinth/' + window3;

        if (game == 9) contanidor = window1 + butons + window2 + 'https://gilbertvs.github.io/Million/' + window3;
